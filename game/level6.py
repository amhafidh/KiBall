try:
    ...
    canvas.pack()
    #myimage = PhotoImage(file='c:\Desktop\projects\game\game1.gif')
    #canvas.create_image(tk, width=500, height=400, anchor=NW, image=myimage)
    ...
    while 1:
        ...
        if time.time()- firstime>15.0:
            time.sleep(0.05)
        elif time.time()- firstime>30.0:
            time.sleep(0.03)
        elif time.time()- firstime>45.0:
            time.sleep(0.01)
        else:
            time.sleep(0.08)
